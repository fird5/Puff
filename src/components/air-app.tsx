...
export function AirApp({ initial }: Props) {
  ...
  return (
    <SkyScene band={band}>
      <main className="mx-auto flex w-full max-w-5xl flex-col gap-4 overflow-x-hidden px-3 pb-24 pt-4 sm:gap-6 sm:px-6 sm:pb-16 sm:pt-10" inert={quizOpen ? true : undefined}>
        ...
        <div className="flex flex-col gap-3 lg:grid lg:grid-cols-[1.15fr_0.85fr] lg:items-start">
          ...
          <section id="puff-more" className="order-3 grid scroll-mt-4 items-center gap-2 sm:grid-cols-[1fr_1.1fr] lg:order-1 lg:col-span-2 lg:row-start-1">
